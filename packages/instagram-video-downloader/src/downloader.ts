...
export async function downloadInstagramMedia(
  ...
  try {
    ...
    console.warn(
      "First method failed, trying alternative methods...",
    ...
    try {
      ...
      console.warn(
        "Embed method failed, trying enhanced method...",
      ...
      try {
        ...
        console.warn(
          "Enhanced method failed, trying alternative approach...",
        ...
        try {
          ...
          console.warn(
            "Alternative method failed, trying session-based method...",
          ...
          try {
            ...
            if (!isReelUrl) {
              return await downloadInstagramMediaMethod5(
                normalizedUrl,
                options,
              );
            } else {
