...
describe("Instagram Downloader Main Module", () => {
  it("should export all necessary functions", () => {
    ...
    assert.ok(
      typeof InstagramDownloader.downloadInstagramMedia === "function",
      "downloadInstagramMedia should be exported",
    );

    assert.ok(
      typeof InstagramDownloader.parseInstagramUrl === "function",
      "parseInstagramUrl should be exported",
    );

    assert.ok(
      typeof InstagramDownloader.getContentType === "function",
