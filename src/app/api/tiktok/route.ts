...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      const thumbnailPublicUrl = result.thumbnail
        ? `/tiktok/${result.videoId}/thumbnail.jpg`
        : "";
      ...
      return NextResponse.json(
        {
          ...
          message:
            "TikTok has strong protections against downloading videos. Try another URL or try again later.",
        },
        { status: 500 },
      );
    }
